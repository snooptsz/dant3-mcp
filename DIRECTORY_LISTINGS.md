...
- Current `server.json` version: `1.0.4`
...
Status: pending marketplace review. The issue documents the remote endpoint, five public read-only tools and the MCP trust boundary.
...
Status: pending triage/review. The submission documents the MIT license, MCP compliance, documentation and security contact.
